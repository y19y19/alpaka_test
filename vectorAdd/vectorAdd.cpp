...
int main()
{
    ...
    //using BufHost = alpaka::Buf<DevHost, float, Dim1D, Idx>;
    ...
    std::cout << "Vector A first three elements: "  << h_A[0] << "," << h_A[1] << "," << h_A[2] << std::endl;
    ...
    std::cout << "Computed vector first three element is: " << h_C[0] << "," << h_C[1] << "," << h_C[2] << std::endl;
    return 0;
}
